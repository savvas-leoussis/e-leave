...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            $accept_link = 'http://localhost/handle_request.php?app_id=' . $application_id . '&accept=true&f_name=' . $f_name . '&l_name=' . $l_name;
            $reject_link = 'http://localhost/handle_request.php?app_id=' . $application_id . '&accept=false&f_name=' . $f_name . '&l_name=' . $l_name;

            $message = file_get_contents('confirm.html', true);
